...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-admin" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
    ...
    echo -e ">>> http://locomotivemtl.github.io/charcoal-admin/apigen/$TRAVIS_BRANCH/ \n"
fi
